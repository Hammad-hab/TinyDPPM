...
class MNIST:
    ...
    def load_data(self):
        self._train_set = torchvision.datasets.MNIST(
            root=MNIST.FOLDER,
            train=True,
            download=True
        )
        self._test_set = torchvision.datasets.MNIST(
            root=MNIST.FOLDER,
            train=False,
            download=True
        )
...
class CIFAR:
    ...
    def load_data(self):
        self._train_set = torchvision.datasets.CIFAR10(
            root=CIFAR.FOLDER,
            train=True,
            download=True,
        ...
        self._test_set = torchvision.datasets.CIFAR10(
            root=CIFAR.FOLDER,
            train=False,
            download=True,
            transform=self._transform
...
class Flowers102:
    ...
    def load_data(self):
        self._train_set = torchvision.datasets.Flowers102(
            root=Flowers102.FOLDER,
            split='train',
            download=True,
            transform=self._transform
        )

        self._test_set = torchvision.datasets.Flowers102(
            root=Flowers102.FOLDER,
            split='test',
            download=True,
            transform=self._transform
...
if __name__ == "__main__":
    ...
    if args[0] == 'cifar':
        ...
        print(
            "Help:\n"
            "\tpython3 Data.py [cifar|mnist|flowers]"
        )