...
class CIFAR:
    ...
    def load_data(self):
        self._train_set = torchvision.datasets.CIFAR10(root=MNIST.FOLDER, train=True, download=True)
        self._test_set = torchvision.datasets.CIFAR10(root=MNIST.FOLDER, train=False, download=True)
